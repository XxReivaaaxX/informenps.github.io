...
<body>
    ...
    <!-- SIDEBAR -->
    <section id="sidebar">
        <a href="../../pag_fd/inicio.php" class="brand"><img src="../../img/banco-falabella.svg" alt="" height="55px"
                width="55px"> Panel Informe NPS | Canales</a>
        <ul class="side-menu">
            <li>
                ...
                <div class="content-data">
                    <div class="head">
                        ...
                        <div class="menu">
                            <i class='bx bx-dots-horizontal-rounded icon'></i>
                            <ul class="menu-link">
                                <li><a href="../../panel_dash/calif_app/panel_calif_app.php" class="btn-delete">Nuevo
                                        Chat</a></li>
                            </ul>
                        </div>
                    </div>
